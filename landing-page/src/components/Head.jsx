  ...
  return (
    <header className="flex items-center justify-between border-b border-[#29382f] px-10 py-3 bg-[#111714] text-white">
      ...
      <nav className="flex gap-8">
        <Link to="/find_booth" className="text-sm font-medium">Find Polling Booth</Link>
        <Link to="/profile" className="text-sm font-medium">Profile</Link>
        <Link to="/team" className="text-sm font-medium">Team</Link>
      </nav>
      <button className="bg-[#38e07b] text-[#111714] px-4 py-2 rounded-full font-bold">
        Get Started
      </button>
    </header>
  );
